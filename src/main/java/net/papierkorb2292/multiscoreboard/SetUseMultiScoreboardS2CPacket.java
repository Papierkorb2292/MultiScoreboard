...
public record SetUseMultiScoreboardS2CPacket(boolean useMultiScoreboard) implements CustomPacketPayload {
    ...
    public static final TypeAndCodec<? super RegistryFriendlyByteBuf, SetUseMultiScoreboardS2CPacket> TYPE = PayloadTypeRegistry.clientboundPlay().register(ID, ByteBufCodecs.BOOL.map(SetUseMultiScoreboardS2CPacket::new, SetUseMultiScoreboardS2CPacket::useMultiScoreboard));
