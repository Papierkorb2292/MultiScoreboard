...
public record RemoveNbtSidebarS2CPacket(String nbtSidebarName) implements CustomPacketPayload {
    ...
    public static final TypeAndCodec<? super RegistryFriendlyByteBuf, RemoveNbtSidebarS2CPacket> TYPE = PayloadTypeRegistry.clientboundPlay().register(ID, ByteBufCodecs.STRING_UTF8.map(RemoveNbtSidebarS2CPacket::new, RemoveNbtSidebarS2CPacket::nbtSidebarName));
